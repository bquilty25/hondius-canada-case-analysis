...
**[View rendered report](https://htmlpreview.github.io/?https://github.com/bquilty25/hondius-canada-case-analysis/blob/main/analysis/canada_case_generation_report.html)**
...
Incubation period and transmission interval distributions for Andes virus were taken from Funk and Abbott's Bayesian re-estimation of the 2018–19 Epuyén outbreak ([epiforecasts/andv-linelist-analysis](https://epiforecasts.io/andv-linelist-analysis/dev)). For each hypothesis, the marginal likelihood of the observed Canadian onset date was computed by integrating over candidate source cases and possible exposure dates, weighting each by the joint probability under the transmission interval distribution (source onset → exposure) and incubation distribution (exposure → Canadian onset). Uncertainty in the epidemiological parameters was propagated by averaging over draws from the Epuyén posterior. The two hypotheses were assigned equal prior weight; posterior probabilities were obtained by normalising the resulting marginal likelihoods.
